            ...
            <ul class="list-none p-0 m-0">
                ...
                <li>
                    <a
                        ...
                        class="flex items-center gap-3 px-4 py-3 text-grey-900 hover:bg-grey-100 transition-all text-[13px] font-medium border-l-[3px] {{ request()->routeIs('dashboard') ? 'bg-grey-100 border-l-primary-600' : 'border-l-transparent' }}"
                    >
                ...
                <li>
                    <a
                        href="#"
                        class="flex items-center gap-3 px-4 py-3 text-grey-900 hover:bg-grey-100 transition-all text-[13px] font-medium border-l-[3px] border-l-transparent"
                    >
                        <svg class="w-[14px] h-[14px]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
