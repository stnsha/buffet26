<nav class="fixed top-0 left-0 right-0 bg-white border-b border-grey-200 z-[1050] h-[60px] shadow-sm">
        ...
        <div class="flex items-center justify-between h-full">
            ...
            <div class="flex items-center">
                ...
                <a href="{{ route('dashboard') }}" class="flex items-center">
                    <span class="text-xl font-bold text-grey-900">Buffet</span>
                    <span class="ml-2 text-xs font-semibold text-primary-600 bg-primary-100 px-2 py-1 rounded-md">26</span>
                </a>
            </div>
